...
<section class="hero-section">
    <div class="hero-container">
        ...
        <div class="hero-image">
            <img src="/webService/wwwroot/img/pantalla.png" alt="Libretas artesanales BookArt">
...
<section class="features-section">
    ...
    <div class="features-grid">
        <article class="feature-card">
            <div class="feature-icon"><img src="/webService/wwwroot/img/card1.png" alt="Sobre nosotros"></div>
        ...
        <article class="feature-card">
            <div class="feature-icon"><img src="/webService/wwwroot/img/card3.png" alt="Nuestra técnica"></div>
        ...
        <article class="feature-card">
            <div class="feature-icon"><img src="/webService/wwwroot/img/card2.png" alt="Nuestros productos"></div>
