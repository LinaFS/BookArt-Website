    ...
    <body>
        ...
        <dialog id="modalAsignarPrecio" class="modal-producto">
            <div class="modal-header">
                ...
                <button class="btn-cerrar" onclick="cerrarModalPrecio()">
                    <span class="material-symbols-outlined">close</span>
                </button>
            </div>
            ...
            <form id="formAsignarPrecio" style="padding: 2rem;">
                ...
                <div class="form-group">
                    <label for="precioPedido">
                        <span class="material-symbols-outlined">payments</span>
                        Precio de la Libreta Personalizada
                    </label>
                    ...
                    <p style="color: var(--text-secondary); font-size: 0.9rem; margin-top: 0.5rem; text-align: center;">
                        Este precio será visible para el cliente
                    </p>
                </div>
